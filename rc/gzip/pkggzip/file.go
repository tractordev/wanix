...
// Compress and Decompression functions used by the File.Process method.
...
// Decompress takes gzip compressed input from io.Reader and expands it.
...
// CheckPath validates the input file path.
...
// CheckOutputPath checks if output path already exists.
...
// Process either compresses or decompresses the input file.
